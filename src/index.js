...
import gamer from './assets/media/GrubbyLogo.png'
import run from './assets/media/run-buddy.png'
import meeting from './assets/media/digital-marketing-meeting.jpg'
import tourney from './assets/media/tourney-tracker.png'
import parents from './assets/media/landingpage.PNG'
                ...
                <div>
                    <a href="https://powerful-citadel-84342.herokuapp.com/" class="Tee-Tracker grid-item">
                        <div>
                            ...
                            <img src={tourney} className="" style={{ width: "25%", maxHeight: "350px" }} alt="people working" />
                        </div>
                        <div>
                        <span>HTML/CSS/JavaScript/APIs</span>
                        </div>
